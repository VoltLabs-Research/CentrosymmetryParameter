...
CentroSymmetryWrapper::CentroSymmetryWrapper()
    : _k(12),
      _mode(CentroSymmetryAnalysis::ConventionalMode) {}

void CentroSymmetryWrapper::setNumNeighbors(int k){
    _k = k;
}

void CentroSymmetryWrapper::setMode(CentroSymmetryAnalysis::CSPMode mode){
    _mode = mode;
}

std::shared_ptr<ParticleProperty> CentroSymmetryWrapper::createPositionProperty(const LammpsParser::Frame& frame){
...
json CentroSymmetryWrapper::compute(const LammpsParser::Frame& frame, const std::string& outputBase){
